...
def helloCallBack():
    ...
    #time.sleep(1)
        ...
        messagebox.showerror("ERROR","SECRET IMAGE NOT SELECTED")
...
def helloCallBack2():
 try:    
    ...
    messagebox.showerror("ERROR","COVER IMAGE NOT SELECTED")
 except:
    messagebox.askretrycancel("LimitExeceeded", "Cover Image Capacity is not Sufficient to Hide")  
...
textbox = Entry(sg, bg="white",width=40,borderwidth=2,relief="solid",fg="#041016",font=("Arial",13))
...
psnr_txt = Entry(sg, bg="white", width=30,font=("Arial",14))
...
ssim_txt = Entry(sg, bg="white", width=30,font=("Arial",14))
