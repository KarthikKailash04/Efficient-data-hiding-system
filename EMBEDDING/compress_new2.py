...
def Compression_Process(path):
    ...
    output_image.save(r"C:\Users\karth\OneDrive\Desktop\Mini Project\c1.jpg")
    return output_image
#path=r"C:\Users\karth\OneDrive\Desktop\40_percent\image_source\pl.jpg"
#Compression_Process(path)
